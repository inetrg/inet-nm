...
Welcome to `inet-nm` contributor's guide.
...
If you experience bugs or general issues with `inet-nm`, please have a look
...
You can help improve `inet-nm` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`inet-nm` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `inet-nm`'s files. While this mechanism can
...
```
conda create -n inet-nm python=3 six virtualenv pytest pytest-cov
conda activate inet-nm
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/inet-nm.git
   cd inet-nm
   ```
...
[repository]: https://github.com/<USERNAME>/inet-nm
[issue tracker]: https://github.com/<USERNAME>/inet-nm/issues
